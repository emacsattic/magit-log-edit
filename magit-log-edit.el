;;; magit-log-edit.el --- [OBSOLETE use at your own risk] major mode for editing Git commit messages
...
;; external `git-commit-mode'.  All issues that library used to have
